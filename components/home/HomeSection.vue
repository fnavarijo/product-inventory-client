<template>
  <section class="my-16 px-10 lg:px-24 xl:px-32 2xl:px-56">
    <header class="text-center mb-16">
      <h2 class="section-name text-3xl text-gray-900 relative leading-10 mb-4 md:mb-0">
        <slot name="title" />
      </h2>
      <span>
        <slot name="subtitle" />
    ...
    <div v-else>
      <div class="grid gap-8 lg:gap-12 xl:gap-16 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <ProductCard
